...
function JioSaavn() {
    ...
    var getAlbum = function (albumid) {
        return apiClient
            ...
            .then(function (res) { return (__assign(__assign({}, res), { data: formatter_1.formatAlbumJson(res.data) })); });
    };
    var getPlaylist = function (listid) {
        return apiClient
            .getJson({ '__call': 'playlist.getDetails', 'listid': listid })
            .then(function (res) { return (__assign(__assign({}, res), { data: formatter_1.formatPlaylistJson(res.data) })); });
    };
